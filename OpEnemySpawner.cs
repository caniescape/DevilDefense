...
public class OpEnemySpawner : MonoBehaviour
{
    ...
    IEnumerator Wave1()
    {
        ...
        while (orderNum < 20)
        {
            ...
            GameObject.Find("OpWave (1)").transform.GetChild(orderNum).gameObject.SetActive(true);
            orderNum++;
    ...
    IEnumerator Wave2()
    {
        ...
        while (orderNum < 20)
        {
            GameObject.Find("OpWave (2)").transform.GetChild(orderNum).gameObject.SetActive(true);
            orderNum++;
            yield return new WaitForSeconds(2.0f);
        }
        yield return null;
    ...
    IEnumerator Wave3()
    {
        ...
        while (orderNum < 20)
        {
            GameObject.Find("OpWave (3)").transform.GetChild(orderNum).gameObject.SetActive(true);
            orderNum++;
            yield return new WaitForSeconds(2.0f);
        }
        yield return new WaitUntil(() => OpEnemies.Count == 0);
    }
    ...
    IEnumerator Wave4()
    {
        ...
        Wave4Ins();
        Debug.Log("적카운트:" + OpEnemies.Count);
        //3초뒤에 Wave시작
        yield return new WaitForSeconds(3.0f);
        ...
        while (orderNum < 20)
        {
            GameObject.Find("OpWave (4)").transform.GetChild(orderNum).gameObject.SetActive(true);
            orderNum++;
            yield return new WaitForSeconds(2.0f);
        }
        yield return new WaitUntil(() => OpEnemies.Count == 0);
    ...
    IEnumerator Wave5()
    {
        ...
        while (orderNum < 20)
        {
            GameObject.Find("OpWave (5)").transform.GetChild(orderNum).gameObject.SetActive(true);
            orderNum++;
            yield return new WaitForSeconds(2.0f);
        }
        yield return new WaitUntil(() => OpEnemies.Count == 0);
